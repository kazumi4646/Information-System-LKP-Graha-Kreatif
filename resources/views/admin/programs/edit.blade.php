                    ...
                    <form method="POST" action="{{ route('admin.programs.update', $program) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="4" 
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('description') border-red-500 @enderror">{{ old('description', $program->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="category" id="category" value="{{ old('category', $program->category) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="price" id="price" step="0.01" min="0" value="{{ old('price', $program->price) }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="duration_weeks" id="duration_weeks" min="1" value="{{ old('duration_weeks', $program->duration_weeks) }}" 
                        ...
                        @if($program->image_path)
                            <div class="mb-4">
                                ...
                                <img src="{{ Storage::url($program->image_path) }}" alt="{{ $program->title }}" 
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-sm text-gray-600">Leave blank to keep current image</p>
                            @error('image')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
